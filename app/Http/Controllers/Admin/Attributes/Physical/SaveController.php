...
class SaveController extends Controller
{
    ...
    public function handle() : RedirectResponse
    {
        ...
        if ($id = $this->request->input('id')) {
            ...
            if (! $attribute) {
                ...
                return redirect()->route('admin.attribute.physical.create');
            }
        }
    ...
    protected function validateRequests() : void
    {
        $this->validate(
            ...
            [
                'name' => [
                    'required',
                    Rule::in($this->getAttributeNames())
                ],
    ...
    protected function saveAttribute(Attribute $attribute = null) : Attribute
    {
        ...
        $attributes = [
            ...
            'name'      => (! is_null($attribute)) ? $attribute->name : $this->request->input('name'),
        ];
    ...
    {
        return redirect()->route('admin.attribute.physical.update', ['id' => $attribute->getKey(), 'name' => $attribute->name]);
    }
}
