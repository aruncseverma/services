...
<head>
    ...
    {{-- styles --}}
    @include('MemberAdmin::common.styles')
...
<body class="@if (! isset($isDefaultClassBodyDisabled)) fix-header card-no-border fix-sidebar @endif">
    ...
    {{-- loader --}}
    @include('MemberAdmin::common.loader')
    {{-- end loader --}}
    ...
    @if (! isset($disableMainWrapper))
        <div id="main-wrapper">
            ...
            {{-- Topbar --}}
            @include('MemberAdmin::common.topbar')
            {{-- End Topbar --}}

            {{-- Sidebar --}}
            @include('MemberAdmin::common.sidebar', ['from' => 'member_admin'])
            {{-- End Sidebar --}}
    ...
    {{-- scripts --}}
    @include('MemberAdmin::common.scripts')
</body>
<!-- Matomo -->
<script>
