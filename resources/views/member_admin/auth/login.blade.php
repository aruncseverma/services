...
@section('main.content')
    <section id="wrapper">
        <div class="login-register">
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{ route('member_admin.auth.login') }}" method="POST" novalidate>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            @include('MemberAdmin::common.form.error', ['key' => 'email'])
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control" type="password" required="" placeholder="@lang('Your Password')" name="password">
                            @include('MemberAdmin::common.form.error', ['key' => 'password'])
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                ...
                                <a href="{{ route('member_admin.auth.forgot_password') }}" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> @lang('Forgot pwd?')</a>
                            </div>
                    </div>
