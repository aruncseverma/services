                ...
                <form method="post" action="{{ route('member_admin.emails.delete') }}">
                    ...
                    <div class="card-body text-right">
                        <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <button type="button" class="btn btn-secondary font-18 text-dark es es-redirect" data-href="{{ route('member_admin.emails.view', $email->id) }}"><i class="mdi mdi-reload"></i></button>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex m-b-40">
                                    ...
                                    <div class="p-l-10">
                                        ...
                                        <small class="text-muted">@lang('From'): {{ $email->sender->email }}</small>
                                    </div>
                                </div>
