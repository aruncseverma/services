<div class="card">
  <div class="card-header">
      <div class="card-actions">
          <a class="btn-minimize" data-toggle="collapse" data-target="#western-union"><i class="mdi mdi-window-minimize"></i></a>
      </div>
      <span>Western Union</span>
  </div>
  <div class="card-header-sub">
      Instructions on how to proceed with your order via Western Union
  </div>
  <div class="card-body collapse show" id="western-union">
      <div class="row">
          <div class="col-sm-4 left-image-holder">
              <img src="{{ asset('assets/theme/admin/default/images/' . $biller->logo) }}">
          </div>
          <div class="col-sm-8">
