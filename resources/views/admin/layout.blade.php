...
<head>
    ...
    <style>
        ...
        .mini-sidebar .navbar-brand b .dark-logo {
...
<body class="@if (! isset($isDefaultClassBodyDisabled)) fix-header card-no-border @endif">
    <div class="preloader">
    ...
    @if (! isset($disableMainWrapper))
        <div id="main-wrapper">
            ...
            {{-- Sidebar --}}
            @include('Admin::common.sidebar', ['from' => 'admin'])
            {{-- End Sidebar --}}
