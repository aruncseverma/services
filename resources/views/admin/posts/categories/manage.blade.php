...
<div class="col-md-6 col-8 align-self-center text-right">
    <a href="{{ route('admin.posts.categories.create') }}" class="btn btn-info">@lang('New')</a>
    @if($categories->count())
    <div class="dropdown" style="display:inline-block;">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a href="#" class="dropdown-item es es-submit es-need-selected-items" data-need-selected-items-selector=".ids" data-form-id="manage_form" data-form-action="{{ route('admin.posts.categories.m_update_status', ['status' => 1]) }}">@lang('Activate selected')</a>
            <a href="#" class="dropdown-item es es-submit es-need-selected-items" data-need-selected-items-selector=".ids" data-form-id="manage_form" data-form-action="{{ route('admin.posts.categories.m_update_status', ['status' => 0]) }}">@lang('Disable selected')</a>
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item es es-submit es-confirm es-need-selected-items" data-need-selected-items-selector=".ids" data-form-id="manage_form" data-form-action="{{ route('admin.posts.categories.m_delete') }}">@lang('Delete selected')</a>
        </div>
    </div>
    @endif
</div>
...
<div class="col-lg-12">
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 col-xlg-4">
            <div class="card card-inverse card-info">
                <a href="{{ route('admin.posts.categories.manage') }}">
                    <div class="box bg-info text-center">
                        <h1 class="font-light text-white">{{ $totalCategories ?? 0 }}</h1>
        ...
        <div class="col-md-6 col-lg-4 col-xlg-4">
            <div class="card card-primary card-inverse">
                <a href="{{ route('admin.posts.categories.manage', ['is_active' => 1]) }}">
                    <div class="box text-center">
                        <h1 class="font-light text-white">{{ $totalActiveCategories ?? 0 }}</h1>
        ...
        <div class="col-md-6 col-lg-4 col-xlg-4">
            <div class="card card-inverse card-warning">
                <a href="{{ route('admin.posts.categories.manage', ['is_active' => 0]) }}">
                    <div class="box text-center">
                        <h1 class="font-light text-white">{{ $totalInactiveCategories ?? 0 }}</h1>
    ...
    <div class="card">
        <div class="card-body">
            {{-- search --}}
            @component('Admin::common.search', ['action' => route('admin.posts.categories.manage')])
            ...
            <form id="manage_form" method="POST">
                ...
                @slot('body')
                @include('Admin::posts.categories.components.table_rows')
                @endslot
                @endcomponent
            </form>
