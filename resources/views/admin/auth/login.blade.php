...
@section('main.content')
    <section id="wrapper">
        <div class="login-register">
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{ route('admin.auth.login') }}" method="POST" novalidate>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                ...
                                <a href="{{ route('admin.auth.forgot_password') }}" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> @lang('Forgot pwd?')</a>
                            </div>
                    </div>
