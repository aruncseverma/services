<div class="col-12">
    <div class="card">
        <div class="card-header" data-toggle="collapse" data-target="#allreviews">
            ...
            <span>@lang('Latest Agency Reviews')</span>
            <button type="submit" class="btn btn-primary" id="elm_view_reviews" data-href="{{ route('agency_admin.reviews') }}"><span class="action-button text-uppercase">@lang('View All Agency Reviews')</span></button>
        </div>
