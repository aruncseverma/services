...
<div class="col-md-6">
    <div class="card">
        ...
        <div class="card-body collapse show" id="prof-photo">
            ...
            <form action="{{ route('agency_admin.profile.upload_profile_photo') }}" method="POST" enctype="multipart/form-data" class="es es-validation">
                @csrf
                <input type="file" class="dropify" name="profile_photo" id="elm_inpt_profile_photo" data-default-file="{{ $agency->profilePhotoUrl }}"/>
                @include('AgencyAdmin::common.form.error', ['key' => 'profile_photo'])
                <label for="elm_inpt_profile_photo" class="es-required es-image" data-error-after-label="true" style="display:none;">Profile Photo</label>
...
@pushAssets('scripts.post')
    ...
    <script type="text/javascript">
        ...
        var DELETE_PROFILE_PHOTO_ACTION_URL = '{{ route("agency_admin.profile.delete_profile_photo") }}';
