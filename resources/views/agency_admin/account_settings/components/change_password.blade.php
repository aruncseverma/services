<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body collapse show" id="change_password">
            ...
            <form method="POST" action="{{ route('agency_admin.account_settings.change_password') }}" class="es es-validation">

                {{ csrf_field() }}

                @component('AgencyAdmin::common.form.group', ['key' => 'current_password', 'labelClasses' => 'es-required'])
                    @slot('label')
                ...
                @component('AgencyAdmin::common.form.group', ['key' => 'confirm_password', 'labelClasses' => 'es-required es-same', 'labelAttrs' => 'data-same-target=current_password'])
                    @slot('label')
                ...
                @component('AgencyAdmin::common.form.group', ['key' => 'new_password', 'labelClasses' => 'es-required es-min-len', 'labelAttrs' => 'data-min-len=6'])
                    @slot('label')
                        @lang('New Password')
                    @endslot
                ...
                @component('AgencyAdmin::common.form.group', ['key' => 'confirm_new_password', 'labelClasses' => 'es-required es-same', 'labelAttrs' => 'data-same-target=new_password'])
                    @slot('label')
