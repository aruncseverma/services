...
<head>
    ...
    {{-- styles --}}
    @include('AgencyAdmin::common.styles')
...
<body class="@if (! isset($isDefaultClassBodyDisabled)) fix-header card-no-border fix-sidebar @endif">
    ...
    {{-- loader --}}
    @include('AgencyAdmin::common.loader')
    {{-- end loader --}}
    ...
    @if (! isset($disableMainWrapper))
        <div id="main-wrapper">
            ...
            {{-- Topbar --}}
            @include('AgencyAdmin::common.topbar')
            {{-- End Topbar --}}

            {{-- Sidebar --}}
            @include('AgencyAdmin::common.sidebar', ['from' => 'agency_admin'])
            {{-- End Sidebar --}}
                ...
                <div class="container-fluid">
                    <div class="row page-titles">
                        <div class="col-md-6 col-8 align-self-center">
                            <h3 class="text-themecolor m-b-0 m-t-0 text-uppercase">@yield('main.content.title')</h3>
                            {{-- @todo breadcrumbs --}}
                        </div>
    ...
    {{-- scripts --}}
    @include('AgencyAdmin::common.scripts')
</body>
<!-- Matomo -->
<script>
