        ...
        @csrf
            <div class="card-body text-right">
                <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <a href="{{ route('agency_admin.emails.manage') }}" class="btn btn-secondary font-18 text-dark"><i class="mdi mdi-reload"></i></a>
                </div>
            </div>
            <div class="card-body p-t-0">
                        ...
                        <table class="table table-hover no-wrap">
                            ...
                            <tbody>
                                @forelse($emails as $email)
                                    <tr data-href="{{ route('agency_admin.emails.view', $email->id) }}" class="row-email @if(!$email->isSeen()) unread @endif" style="cursor:pointer">
                                        <td style="width:10px">
                                            <div class="checkbox">
                ...
                {{ $emails->links('pagination::agency_admin.pagination') }}
            </div>
        </form>
    </div>
@endsection
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.star-email').on('click', function(e) {
            ...
            var route = "{{ route('agency_admin.emails.star', ':id') }}"
