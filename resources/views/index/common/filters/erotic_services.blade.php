...
<div class="item-content row" id="filter_erotic_services">
    @php
    ...
    <div class="col-lg-5">
        <div class="custom-control custom-checkbox">
            <input type="checkbox" class="custom-control-input" id="{{ $service->id }}" value="{{ $service->id }}" @if(in_array($service->id, $eroticServiceIds)) checked @endif>
