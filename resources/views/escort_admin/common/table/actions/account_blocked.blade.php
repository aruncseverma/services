@if ($isBlocked)
    <button class="btn btn-warning btn-xs" title="{{ __('Unblock Account') }}" data-blocked-account-id="{{ $id }}" data-blocked-account-to="{{ $to }}">
        <i class="fa fa-circle-o"></i>
    </button>
@else
    <button class="btn btn-warning btn-xs" title="{{ __('Block Account') }}" data-blocked-account-id="{{ $id }}"data-blocked-account-to="{{ $to }}">
