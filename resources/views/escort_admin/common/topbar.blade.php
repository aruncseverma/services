<header class="topbar" style="z-index:1000">
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        <div class="navbar-header">
            {{-- Brand --}}
            <a class="navbar-brand" href="{{ route('escort_admin.dashboard') }}">
                <i>
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown mega-dropdown"> 
                    <div class="nav-link">
                        ...
                        <a href="{{ route('escort_admin.buycredits') }}" class="btn btn-info">{{ __('strings.buymore') }}</a>
                    </div>
                </li>
                <!-- ============================================================== -->
                <!-- End Coins -->
                ...
                @include('EscortAdmin::common.locales')
            </ul>
        </div>
    </nav>
</header>
...
<script>
    ...
    var user = '{{ Auth::user()->getKey() }}';
    var channel = pusher.subscribe('escort-channel-' + user);
