<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body collapse show" id="update_email">
            ...
            <form method="POST" action="{{ route('escort_admin.account_settings.update_email') }}" class="es es-validation">

                {{ csrf_field() }}

                @component('EscortAdmin::common.form.group', ['key' => 'change_email', 'labelClasses' => 'es-required es-email', 'labelId' => 'change_email'])
                    @slot('label')
                        @lang('E-mail Address')
                    @endslot
