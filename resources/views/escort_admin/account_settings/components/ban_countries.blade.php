<div class="col-md-6">
    <div class="card">
        ...
        <div class="card-body collapse show" id="ban_countries_card">
            ...
            <form method="POST" action="{{ route('escort_admin.account_settings.ban_countries') }}">

                {{ csrf_field() }}

                @component('EscortAdmin::common.form.group', ['key' => 'ban_countries'])
                    @slot('input')
                        @include('EscortAdmin::common.form.country', [
                            'name' => 'ban_countries', 
                            'is_multiple' => true, 
                            'value' => $banIds,
