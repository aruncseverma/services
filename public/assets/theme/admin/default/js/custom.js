...
$(function () {
    ...
    // accordion stop trigger on buttons 

    $('.card-header .btn').click( function (e) {
        e.stopPropagation()
    });

    $('.card-header .dropdown-menu').click( function (e) {
        e.stopPropagation()
    });

    // $('.card-header').click(function (e) {      
    //     e.preventDefault();
    //     $(this).find('.mdi').toggleClass('mdi-window-minimize mdi-window-maximize');
    // });

    // fix dropdown on card
    ...
    $('.card-body.collapse')
        .on('hide.bs.collapse', function () {
            ...
            $card.find('.card-header .mdi').toggleClass('mdi-window-minimize mdi-window-maximize');
        })
